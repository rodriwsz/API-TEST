...
| US4 | Como diretor de desenvolvimento económico, quero que o processamento em Python normalize os dados por setor industrial para sustentar métricas precisas.         | Baixa 🟢     | 2 pontos   |
